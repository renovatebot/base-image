...
FROM ghcr.io/containerbase/sidecar:14.13.18@sha256:6fa0c7450cac1fbc37275790c2caded46c05c2b0fde100fc8f57e9d430df2d70 AS base
...
RUN install-tool flutter 3.44.9
...
RUN install-tool mise v2026.8.3
