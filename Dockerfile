...
FROM ghcr.io/containerbase/sidecar:14.13.9@sha256:f03670e11f14a9f90fd34d9137f83b6284e8a4c44819200fa537bcca02c55139 AS base
...
RUN install-tool flutter 3.44.7
...
RUN install-tool mise v2026.7.11
