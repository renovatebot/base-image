...
FROM ghcr.io/containerbase/sidecar:14.0.1@sha256:d4edd35638fe8224e179818461feb4336210d3b46745fdb6b6e2c858855086d4 AS base
...
RUN install-tool golang 1.25.7
...
RUN install-tool bundler 4.0.5
