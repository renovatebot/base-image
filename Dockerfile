...
FROM ghcr.io/containerbase/sidecar:14.13.10@sha256:c09b97fffbe5fb846b6272192e3540eff7033457e83d0f9896b2863501e2371f AS base
...
RUN install-tool bundler 4.0.17
...
RUN install-tool mise v2026.7.14
