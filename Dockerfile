...
FROM ghcr.io/containerbase/sidecar:14.16.0@sha256:8f071f80989c5f63b161164207edde16181c473c8f3d9b50813dd450bf21c226 AS base
...
RUN install-tool erlang 28.5.0.7
...
RUN install-tool ruby 4.0.7

# renovate: datasource=rubygems
RUN install-tool bundler 4.0.21
...
RUN install-tool devbox 0.18.3
...
RUN install-tool mise v2026.9.12
