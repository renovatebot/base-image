...
FROM ghcr.io/containerbase/sidecar:9.31.5@sha256:a5de39f18e341908c1b5dc3d6e5357a3f861caf1c14e87ba4a0fd9fb9447a643 AS base
...
RUN install-tool pipenv 2023.11.17
