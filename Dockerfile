...
FROM ghcr.io/containerbase/sidecar:14.12.5@sha256:f9df2abd0ef337d6e8da5ca01732b2c9267bd5eaecb65d30841fa873027220f4 AS base
...
RUN install-tool flutter 3.44.4
...
RUN install-tool mise v2026.7.0
