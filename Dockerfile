...
FROM ghcr.io/containerbase/sidecar:14.4.10@sha256:ac9b85141997df344e9ec2c35fb3e50b2930b7224efa441b5320e2c17a0cd170 AS base
...
RUN install-tool erlang 28.3.2.0
...
RUN install-tool flutter 3.41.3
