...
FROM ghcr.io/containerbase/sidecar:13.8.59@sha256:892221bc1654c79ef855415dbed80d9688812e10ac2e400bc55b3db3e0e4bec1 AS base
...
RUN install-tool bundler 2.7.0
