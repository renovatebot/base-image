...
FROM ghcr.io/containerbase/sidecar:13.8.36@sha256:36b2e0a096752a4c0fa58ffecad7d5ee792f85502cc768b06fb873829f51afbe AS base
...
RUN install-tool flutter 3.32.1
