...
FROM ghcr.io/containerbase/sidecar:13.7.17@sha256:c7f6de5a3fa87d28ad8d793fa0e3d678c5822a361131091d69b794ebc2aa30b9 AS base
...
RUN install-tool bundler 2.6.4
...
RUN install-tool flutter 3.29.0
