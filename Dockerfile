...
FROM ghcr.io/containerbase/sidecar:14.5.3@sha256:7e1c65abc1027efa67a6b764418308676eab6f13e1123c98041985614e02bf71 AS base
...
# renovate: datasource=pypi
RUN install-tool copier 9.13.1
