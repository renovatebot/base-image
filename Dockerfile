...
FROM ghcr.io/containerbase/sidecar:10.15.3@sha256:fa0dafed69668f6c809add58986cd887b6366971d138e98f16dda8551c1d0f1a AS base
...
RUN install-tool bundler 2.5.15
