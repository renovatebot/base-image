...
FROM ghcr.io/containerbase/sidecar:13.8.13@sha256:176b93f5732bde85e7f1dfa8b66e3a1e451c7df0ea8ba3273d7ac221f6934106 AS base
...
RUN install-tool erlang 27.3.2.0
...
RUN install-tool bundler 2.6.7
