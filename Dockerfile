...
FROM ghcr.io/containerbase/sidecar:14.13.14@sha256:1e912c90095c5061e36f7337004478bcaf8270387e651d8f210b46f775a6ffae AS base
...
RUN install-tool flutter 3.44.8
...
RUN install-tool mise v2026.8.2
