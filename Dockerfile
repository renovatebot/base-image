...
FROM ghcr.io/containerbase/sidecar:13.23.1@sha256:38c522a26df1dfba479f337ee8253076798ea858fa102545aacc3cfd4c13f91b AS base
...
RUN install-tool elixir v1.19.0
...
RUN install-tool flutter 3.35.6
