...
FROM ghcr.io/containerbase/sidecar:14.12.10@sha256:58a489a06d7670bbc3ab8df813612144fe742e02b8b3d748787b0bbcc5aa58d0 AS base
...
# renovate: datasource=pypi
RUN install-tool copier 9.16.0
