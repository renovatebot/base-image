...
FROM ghcr.io/containerbase/sidecar:13.26.20@sha256:9031fb7e5216a40df678be3cea5337e3ee1791b71289dfcdac7c222b64649359 AS base
...
RUN install-tool dotnet 9.0.311
...
RUN install-tool flutter 3.41.0
