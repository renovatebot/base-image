...
FROM ghcr.io/containerbase/sidecar:14.14.0@sha256:897bce9047e2fb17dca75ac09fc417b290e236e4fd31e30aa056f5000bd5ddbb AS base
...
RUN install-tool gradle 9.7.0


# renovate: datasource=github-releases packageName=containerbase/erlang-prebuild versioning=docker
RUN install-tool erlang 28.5.0.4

# renovate: datasource=github-releases packageName=elixir-lang/elixir
RUN install-tool elixir v1.20.3
...
RUN install-tool golang 1.26.6
...
RUN install-tool conan 2.31.2

# renovate: datasource=pypi
RUN install-tool copier 9.17.1

# renovate: datasource=pypi
RUN install-tool hashin 1.0.5

# renovate: datasource=pypi
RUN install-tool pdm 2.28.2

# renovate: datasource=pypi
RUN install-tool pip-tools 7.6.0

# renovate: datasource=pypi
RUN install-tool pipenv 2026.7.1

# renovate: datasource=pypi
RUN install-tool poetry 2.4.1

# renovate: datasource=pypi
RUN install-tool uv 0.12.5
...
RUN install-tool ruby 4.0.6

# renovate: datasource=rubygems
RUN install-tool bundler 4.0.18
...
RUN install-tool bazelisk v1.29.0
...
RUN install-tool mise v2026.8.8
