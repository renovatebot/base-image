...
FROM ghcr.io/containerbase/sidecar:13.25.21@sha256:1cab63130e422cc144ae87da3ae74bb1365f09ee43ec66ceb1718c3e23ed9111 AS base
...
# renovate: datasource=pypi
RUN install-tool copier 9.11.0

# renovate: datasource=pypi
RUN install-tool hashin 1.0.5

# renovate: datasource=pypi
RUN install-tool pdm 2.26.4
...
RUN install-tool dotnet 9.0.308


# renovate: datasource=github-releases packageName=helm/helm
RUN install-tool helm v3.19.4
