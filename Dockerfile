...
FROM ghcr.io/containerbase/sidecar:11.11.42@sha256:22dc7d5cef8515bf754697c93371a61ebe6552cf742a1dda78b3444b03e81a40 AS base
...
# renovate: datasource=pypi
RUN install-tool pdm 2.20.0.post1
