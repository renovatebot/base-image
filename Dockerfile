...
FROM ghcr.io/containerbase/sidecar:14.10.10@sha256:d0d75b77581695808b3948f4d1f3963d7e9c3b3a7ccac4af4096dcb4efa0be5c AS base
...
RUN install-tool erlang 28.5.0.0
...
RUN install-tool conan 2.28.1

# renovate: datasource=pypi
RUN install-tool copier 9.15.1

# renovate: datasource=pypi
RUN install-tool hashin 1.0.5

# renovate: datasource=pypi
RUN install-tool pdm 2.26.8

# renovate: datasource=pypi
RUN install-tool pip-tools 7.5.3

# renovate: datasource=pypi
RUN install-tool pipenv 2026.6.1

# renovate: datasource=pypi
RUN install-tool poetry 2.3.4

# renovate: datasource=pypi
RUN install-tool uv 0.11.14
...
RUN install-tool ruby 4.0.4

# renovate: datasource=rubygems
RUN install-tool bundler 4.0.11
...
RUN install-tool devbox 0.17.2
