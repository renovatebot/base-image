...
FROM ghcr.io/containerbase/sidecar:14.12.12@sha256:6a4008463153728f4586a75f33f3304f116faf7d8bb9360e5b41e6ac7ad6baea AS base
...
RUN install-tool conan 2.30.0

# renovate: datasource=pypi
RUN install-tool copier 9.17.0

# renovate: datasource=pypi
RUN install-tool hashin 1.0.5

# renovate: datasource=pypi
RUN install-tool pdm 2.28.0

# renovate: datasource=pypi
RUN install-tool pip-tools 7.5.3

# renovate: datasource=pypi
RUN install-tool pipenv 2026.6.2

# renovate: datasource=pypi
RUN install-tool poetry 2.4.1

# renovate: datasource=pypi
RUN install-tool uv 0.11.28
...
RUN install-tool ruby 4.0.5

# renovate: datasource=rubygems
RUN install-tool bundler 4.0.16
...
RUN install-tool mise v2026.7.5
