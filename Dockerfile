...
FROM ghcr.io/containerbase/sidecar:14.14.7@sha256:6409580d105c51878508bb6c87f57006004d2c3ee7e71c243f86a4b399da8832 AS base
...
RUN install-tool flutter 3.47.3
...
RUN install-tool mise v2026.9.5
