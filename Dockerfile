...
FROM ghcr.io/containerbase/sidecar:10.6.0@sha256:ed6ae6cfd7f084284981aa10bf22116bc76fa32bce03c61d2bf347bed2db3f18 AS base
...
RUN install-tool composer 2.7.5
