...
FROM ghcr.io/containerbase/sidecar:14.18.2@sha256:153e7efd5b76560cc111af3df1410aeddab4b115e01be1de8c989eb6f7f1dd1b AS base
...
RUN install-tool devbox 0.18.4
...
RUN install-tool mise v2026.9.14
